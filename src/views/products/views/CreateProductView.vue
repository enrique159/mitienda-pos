<template>
  <div class="p-8 pt-4 w-full overflow-y-auto max-w-[1080px] mx-auto">
    <h6 class="text-2xl font-bold mb-4">Crear nuevo producto</h6>
...
// ADD TAX 002-1 TO TAXES APPLIED
const tax16 = taxes.value.find((tax) => tax.identifier === '002-1') || null
!!tax16 && taxesApplied.value.push(tax16)

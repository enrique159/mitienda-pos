...
onBeforeMount(() => {
  ...
  if (product) {
    ...
    formData.id_category = product.id_category
    formData.id_provider = product.id_provider
    formData.stock = product.stock
    formData.stock_minimum = product.stock_minimum
    formData.unlimited_stock = product.unlimited_stock
    formData.selling_price = convertCentsToDecimals(product.selling_price)
    formData.purchase_price = convertCentsToDecimals(product.purchase_price)
    formData.is_bulk = product.is_bulk
    formData.unit_measurement = product.unit_measurement
...
const convertCentsToDecimals = (value: number) => {
...
const formData = reactive({
  ...
  expiration_date: undefined as Date | undefined | null,

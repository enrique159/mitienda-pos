...
exports.seed = async function(knex) {
  try {
    ...
    await knex('providers').insert([
      ...
      {
        id: 'b2e1c1a4-8c3a-11ec-a8a3-0242ac120021', // UUID generado
        id_company: 'b2e1c1a4-8c3a-11ec-a8a3-0242ac120002', // ID de la empresa relacionada
        name: 'Proveedor 2', // Nombre del proveedor
        contact_name: 'Contacto 2', // Nombre del contacto
        email: 'contacto2@mail.com', // Correo electrónico
        phone: '5551234567', // Teléfono
        address: 'Calle Principal #123, Centro', // Dirección

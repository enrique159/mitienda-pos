...
const ErrorCodes = {
  ...
  ERR0002: {
    ...
    description:
      'The data you are trying to update is outdated. Please refresh the page and try again.',
  },
  ERR0003: {
    code: 'ERR0003',
    category: ErrorCategory.USER,
    ...
    description:
      'Ensure that the pagination parameters are in the correct format',
  },
  ERR0004: {
    code: 'ERR0004',
    category: ErrorCategory.USER,
  ...
  ERR0100: {
    ...
    msg: 'BOOKING_MODULE',
    description:
      'Incorrect value for nights parameter, arrival and departure does not match.',
  },
  ERR0101: {
    code: 'ERR0101',
    category: ErrorCategory.USER,
    msg: 'BOOKING_MODULE',
    description:
      'Incorrect value for nights parameter, value must be a number.',
  },
  ERR0102: {
    code: 'ERR0102',
    category: ErrorCategory.USER,
  ...
  ERR0104: {
    ...
    msg: 'BOOKING_MODULE',
    description:
      'Incorrect value for nights parameter, value must be a positive number.',
  },
  ERR0105: {
    code: 'ERR0105',
    category: ErrorCategory.USER,
  ...
  ERR0108: {
    ...
    msg: 'BOOKING_MODULE',
    description:
      'Incorrect value for room category pms, value must be a string',
  },
  ERR0109: {
    code: 'ERR0109',
    category: ErrorCategory.USER,
